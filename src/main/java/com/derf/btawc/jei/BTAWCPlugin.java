...
public class BTAWCPlugin extends BlankModPlugin {
	...
	public void register(IModRegistry registry) {
		...
		// Add Category 
		registry.addRecipeCategories(new AlloyFurnaceRecipeCategory(guiHelper), new ChipMakerRecipeCategory(guiHelper));
		// Add Handler
		registry.addRecipeHandlers(new AlloyFurnaceRecipeHandler(), new ChipMakerRecipeHandler());
